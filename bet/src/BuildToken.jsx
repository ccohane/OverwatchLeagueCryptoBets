      ...
      BuildToken(){
        ...
        this.state.web3.eth.getAccounts((error, accounts) => {
            ...
            .then((result) => {
             ...
             console.log(this.state.InputAmount*this.state.weiConversion);
             console.log(BettingInstance.options);
             //BettingInstance.setAdmin(accounts[0])
             BettingInstance.methods.BuildToken(1,10,11).send({from: accounts[0],value: this.state.InputAmount*this.state.weiConversion, gas: 4600000})
            })
              .then((result) => {
                  console.log('result')
